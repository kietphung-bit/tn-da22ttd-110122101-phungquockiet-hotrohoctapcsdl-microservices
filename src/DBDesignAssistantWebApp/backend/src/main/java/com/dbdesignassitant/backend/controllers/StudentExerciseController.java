...
public class StudentExerciseController {
    ...
    public ResponseEntity<ApiResponse<List<ExerciseResponse>>> getStudentExercises(
        ...
        List<ExerciseResponse> data = exerciseService.getStudentExercises(search, archived);
    ...
    public ResponseEntity<ApiResponse<ExerciseResponse>> archiveStudentExercise(@PathVariable Long id) {
        ExerciseResponse data = exerciseService.setStudentExerciseArchived(id, true);
        ApiResponse<ExerciseResponse> response = ApiResponse.<ExerciseResponse>builder()
                .status(HttpStatus.OK.value())
                .message("Success")
                .data(data)
    ...
    public ResponseEntity<ApiResponse<ExerciseResponse>> restoreStudentExercise(@PathVariable Long id) {
        ExerciseResponse data = exerciseService.setStudentExerciseArchived(id, false);
        ApiResponse<ExerciseResponse> response = ApiResponse.<ExerciseResponse>builder()
                .status(HttpStatus.OK.value())
                .message("Success")
                .data(data)
